...
CREATE TABLE IF NOT EXISTS respuestas (
  ...
  nombre_completo TEXT, identificacion TEXT, telefono TEXT,
  correo TEXT, cargo TEXT, institucion TEXT,
  puntaje_total INTEGER, nivel_desempeno TEXT,
  dominio_1_puntaje INTEGER, dominio_1_porcentaje INTEGER,
  dominio_2_puntaje INTEGER, dominio_2_porcentaje INTEGER,
  dominio_3_puntaje INTEGER, dominio_3_porcentaje INTEGER,
  dominio_4_puntaje INTEGER, dominio_4_porcentaje INTEGER,
  dominio_5_puntaje INTEGER, dominio_5_porcentaje INTEGER,
  dominio_6_puntaje INTEGER, dominio_6_porcentaje INTEGER,
  dominio_7_puntaje INTEGER, dominio_7_porcentaje INTEGER,
  dominio_8_puntaje INTEGER, dominio_8_porcentaje INTEGER,
...
DROP POLICY IF EXISTS "Cualquiera puede insertar respuestas" ON respuestas;
...
DROP POLICY IF EXISTS "Instituciones visibles para todos" ON instituciones;
CREATE POLICY "Instituciones visibles para todos" ON instituciones
  FOR SELECT USING (true);

DROP POLICY IF EXISTS "Solo admin puede modificar instituciones" ON instituciones;
